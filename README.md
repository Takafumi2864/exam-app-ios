...
- セクションごとに詳細なコンポーネント（例：休憩時間）を設定し、正確な時間管理が可能
- デジタル / アナログ時計で残り時間を表示
- テスト中の一時停止・再開・次セクションの移動に対応
...
### ユーザー認証
- Google / Apple / Email によるログイン・新規登録
...
| その他 | AudioToolbox, AuthenticationServices, CryptoKit, Security, WebKit |
